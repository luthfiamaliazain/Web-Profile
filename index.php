...
$ambilalumni = mysqli_query($koneksi,"SELECT * FROM alumni LIMIT 5");
...
<a id="wifitimbul">
  ...
  <div class="card-panel center">
    ...
    <!-- alumni -->
\
          <h3 class="light center grey-text text-darken-3" style="margin-top: 50px">Testimonial Alumnus</h3>
          <div class='content'>
  <div class='slider single-item' style="height: 300px!important">
    <?php foreach ($ambilalumni as $key => $value): ?>
      
    
    <div class='quote-container'>
      <div class='portrait octogon'>
        <img alt='' src='./assets/img/fotoalumni/<?= $value['foto'] ?>'>
      </div>
      <div class='quote'>
        <blockquote>
          <p><?= $value['kesan'] ?></p>
          <cite>
            ...
            <br>
            <?= $value['jurusan'] ?> - <?= $value['angkatan'] ?>
            <br>
            <?= $value['pekerjaan_sekarang'] ?>
          </cite>
        </blockquote>
      </div>
    </div>
