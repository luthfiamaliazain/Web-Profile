			...
			<div class="col-md-12">
				<div class="card card-user">
					<div class="card-header">
						<div class="row">
							<div class="col-6">
								<h5 class="card-title">Our Servis</h5>
							</div>
							<div class="col-6 text-right">
								<a href="tambahdata.php"><button class="btn btn-primary" type="button">Tambah Data</button></a>
							</div>
						</div>
					</div>
					<div class="card-body">
						<?php include 'proses/seluruhdata.php'; ?>
					</div>
				</div>
			</div>
		</div>
