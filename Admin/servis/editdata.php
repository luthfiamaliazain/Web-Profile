...
$id = $_GET['id'];
$ambil = mysqli_query($koneksi, "SELECT * FROM `servis` WHERE `id` = '$id'");
			...
			<div class="col-md-12">
				<div class="card card-user">
					<div class="card-header">
						<h5 class="card-title">Update Post : <?= $info ?></h5>
					</div>
					<div class="card-body">
						<form action="proses/editdataservis.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<textarea class="form-control" placeholder="info" name="info"><?= $info ?></textarea>
							</div>
